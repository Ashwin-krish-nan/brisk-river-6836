 ...
 function render(pro_data){
      ...
      let New_data = pro_data.map((elm)=>{
         ...
         <div class="card">
            ...
            <h6>Limited Edition<span class="material-symbols-outlined" id="add_cart" data-id=${elm._id}>add_shopping_cart</span></h6>
            <u>${elm.name}</u>
            <div class="rate">
               <p>$${elm.price}.00<span>Comp.Value:$${elm.price*2}.00</span></p>
               <div>${elm.rating}</div>
            </div>
         </div>   
         `
